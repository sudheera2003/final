...
# Prices updated to realistic LKR bulk/wholesale prices
# Added a 7th value to each item: custom low_stock_threshold
# ==========================================
inventory_data = [
    # Italian / Pizza
...
# Prices updated to realistic LKR Restaurant/Hotel menu prices
# ==========================================
menu_data = [
    # --- PIZZAS ---
